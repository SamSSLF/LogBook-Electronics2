...
oled.poweron()
oled.init_display()
oled.draw_text(0,0, 'Lab 5 - Exercise 2b')
oled.display()
...
while True:				# loop forever until CTRL-C
	...
	if ((toc-tic) >= 100):
		...
		# Display new speed
		oled.draw_text(0,20,'Motor A:{:5.2f} rps'.format(A_speed/39))   # motor speed is calculated here
		oled.draw_text(0,30,'Motor B:{:5.2f} rps'.format(B_speed/39))
		oled.draw_text(0,40,'Motor Drive: {:d}%'.format(speed))
		oled.display()
		tic = pyb.millis()
